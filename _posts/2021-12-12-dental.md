...
The flip transformations induce errors by generating for the same image multiple versions in which quadrants have different classifications. The positions should be preserved and exploited. 
